...
class LangGraphAgent:
    ...
    async def _chat(self, state: GraphState, config: RunnableConfig) -> Command:
        ...
        When users ask about project tasks, always use the get_project_tasks tool.
        You MUST use tools whenever the user asks about projects or tasks. Never answer from general knowledge for Zoho project data.
        If the user asks about tasks, ALWAYS use get_project_tasks.
        If the user asks about projects, ALWAYS use list_projects.
        """
